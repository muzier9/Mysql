...
//        addLogFragment();
        ...
        mSettingsClient = LocationServices.getSettingsClient(this);//检查定位是否可用
        mLocationRequest = new LocationRequest();
        // Sets the interval for location update (unit: Millisecond)
//        mLocationRequest.setInterval(5000);//每间隔5000ms重新获取地理定位
        // Sets the priority
        mLocationRequest.setPriority(LocationRequest.PRIORITY_HIGH_ACCURACY);//高精度模式
                    ...
                    if (locationResult != null) {
                        ...
                        if (!locations.isEmpty()) {
                            for (Location location : locations) {
                                ...
                                Intent intent=new Intent(RequestLocationUpdatesWithCallbackActivity.this,SupportMapDemoActivity.class);
        ...
        try {
            ...
            locationSettingsResponseTask.addOnSuccessListener(new OnSuccessListener<LocationSettingsResponse>() {
                ...
                public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(Exception e) {//提示用户打开定位服务
